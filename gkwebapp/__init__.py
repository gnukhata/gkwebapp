...
def main(global_config, **settings):
	...
	config.add_route('showgodown', '/showgodown')
 	config.add_route('showmultigodown', '/showmultigodown')
 	config.add_route('showeditgodown', '/showeditgodown')
 	config.add_route('godownexists', '/godownexists')
 	config.add_route('addgodown', '/addgodown')
 	config.add_route('addmultigodowns', '/addmultigodowns')
 	config.add_route('getgoddetails', '/getgoddetails')
 	config.add_route('editgodown', '/editgodown')
 	config.add_route('deletegodown', '/deletegodown')
