...
def stockreportspreadsheet(request):
	...
	if godownflag > 0:
		...
		sheet.getCell(3,4).stringValue("Deli Note No.").setBold(True)
		sheet.getCell(4,4).stringValue("INV No.").setBold(True)
		sheet.getCell(5,4).stringValue("TN No.").setBold(True)
		sheet.getCell(6,4).stringValue("RN No.").setBold(True)
		sheet.getCell(7,4).stringValue("Inward").setBold(True).setAlignHorizontal("right")
		sheet.getCell(8,4).stringValue("Outward").setBold(True).setAlignHorizontal("right")
		sheet.getCell(9,4).stringValue("Balance").setBold(True).setAlignHorizontal("right")
		row = 5
		for stock in result:
			if stock["particulars"]=="opening stock" and stock["dcno"]=="" and stock["invno"]=="" and stock["date"]=="":
				...
				sheet.getCell(7, row).stringValue(stock["inward"]).setAlignHorizontal("right")
				sheet.getCell(8, row).stringValue("")
				sheet.getCell(9, row).stringValue("")
			if stock["particulars"]!="Total" and (stock["dcno"]!="" or stock["invno"]!="" or stock["tnno"]!="" or stock["rnno"] != "") and stock["date"]!="":
				...
				sheet.getCell(7, row).stringValue(stock["inwardqty"]).setAlignHorizontal("right")
				sheet.getCell(8, row).stringValue(stock["outwardqty"]).setAlignHorizontal("right")
				sheet.getCell(9, row).stringValue(stock["balance"]).setAlignHorizontal("right")
			if stock["particulars"]=="Total" and stock["dcno"]=="" and stock["invno"]=="" and stock["date"]=="":
				...
				sheet.getCell(5, row).stringValue("")
				sheet.getCell(6, row).stringValue("")
				sheet.getCell(7, row).stringValue(stock["totalinwardqty"]).setAlignHorizontal("right")
				sheet.getCell(8, row).stringValue(stock["totaloutwardqty"]).setAlignHorizontal("right")
				sheet.getCell(9, row).stringValue("")
			row += 1
	else:
		sheet.getCell(0,0).stringValue(orgname).setBold(True).setAlignHorizontal("center").setFontSize("16pt")
		...
		sheet.getCell(3,3).stringValue("Deli Note No.").setBold(True)
		sheet.getCell(4,3).stringValue("INV No.").setBold(True)
		sheet.getCell(5,3).stringValue("RN No.").setBold(True)
		sheet.getCell(6,3).stringValue("Inward").setBold(True).setAlignHorizontal("right")
		sheet.getCell(7,3).stringValue("Outward").setBold(True).setAlignHorizontal("right")
		sheet.getCell(8,3).stringValue("Balance").setBold(True).setAlignHorizontal("right")
		row = 4
		for stock in result:
			if stock["particulars"]=="opening stock" and stock["dcno"]=="" and stock["invno"]=="" and stock["date"]=="":
				sheet.getCell(0, row).stringValue("")
