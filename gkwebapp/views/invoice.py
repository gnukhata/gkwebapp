...
def listofinvspreadsheet(request):
	...
	sheet.getCell(0,2).stringValue("Period: "+rdatetime.strptime(request.params["fromdate"],'%Y-%m-%d').strftime('%d-%m-%Y')+" To "+datetime.strptime(request.params["todate"],'%Y-%m-%d').strftime('%d-%m-%Y')).setBold(True).setAlignHorizontal("center").setFontSize("12pt")
	...
	sheet.getColumn(9).setWidth("4cm")
	sheet.getColumn(10).setWidth("4cm")
	sheet.getColumn(11).setWidth("5cm")
