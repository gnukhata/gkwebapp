...
$(document).ready(function() {
  ...
  $("#invoicetypeselect").keydown(function(e){
    ...
    $("#viewlist_submit").click(function(event) {
  	    ...
  	    var dataset = {};
  	    dataset = {"flag":$("invoicetypeselect option:selected").val(), "fromdate":$("#viewlist_fromyear").val()+"-"+$("#viewlist_frommonth").val()+"-"+$("#viewlist_fromdate").val(),"todate":$("#viewlist_toyear").val()+"-"+$("#viewlist_tomonth").val()+"-"+$("#viewlist_todate").val()};
