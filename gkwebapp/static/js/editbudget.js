...
// ----------- end validation -----------
        ...
        dataset = {"budid":$("#budgetlist option:selected").val(),"contents":JSON.stringify(content),"budname":$("#bname").val(),"startdate":fromdate,"enddate":todate,"btype":$("#btype option:selected").val(),"gaflag":1};
        // }
